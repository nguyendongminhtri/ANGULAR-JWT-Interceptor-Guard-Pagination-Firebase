...
@NgModule({
  declarations: [AppComponent, HomeComponent, GettingStartedComponent, RegisterComponent, LoginComponent, UserAccountComponent, UploadFileComponent, CreateSongComponent],
  imports: [
    HttpClientModule,
    BrowserModule,
    FormsModule,
    ...
    AngularFireModule.initializeApp(environment.firebaseConfig), MatProgressBarModule
  ],
